...
import { createProjectUpdate, parseProjectUpdateInput } from '@garun/core/review';
  ...
  try {
    ...
    return NextResponse.redirect(
      publicAppUrl(
        ...
        `/workspace/${slug}/projects/${projectSlug}/review?success=update`,
      ),
      303,
    );
  } catch {
    return NextResponse.redirect(
      publicAppUrl(
        environment.PUBLIC_APP_URL,
        `/workspace/${slug}/projects/${projectSlug}/review?error=update`,
      ),
      303,
    );
  }
