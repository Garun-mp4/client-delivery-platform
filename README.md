...
Playwright использует установленный системный Google Chrome и запускает production web server из
готового build. Отдельный браузерный binary не скачивается:
